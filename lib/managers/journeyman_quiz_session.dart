...
class JourneymanQuizSession extends QuizSession {
  JourneymanQuizSession({required QuestionRepository questionRepository, totalQuestionCount = 15}) : super(questionRepository: questionRepository, totalQuestionCount: totalQuestionCount);
