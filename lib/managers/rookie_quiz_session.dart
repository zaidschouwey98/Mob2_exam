...
class RookieQuizSession extends QuizSession {
  RookieQuizSession({required QuestionRepository questionRepository, totalQuestionCount = 10}) : super(questionRepository: questionRepository, totalQuestionCount: 10);
